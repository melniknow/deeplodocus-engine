...
GAMES_DIRECTORY = "/home/sergey/DeepChess/games/"	# Directory where the pgn games are saved
STORING_PATH = '/home/sergey/DeepChess/eval/'		# Where to store the games evaluated by Stockfish

engine = chess.uci.popen_engine('/home/sergey/stockfish/stockfish-ubuntu-x86-64-avx2')	# Be sure to have Stockfish installed
engine.uci()
...
def process_game(game):
	...
	node = game
	depth = 8	#Milliseconds, the lower the more approximate Stockfish's evaluation is
	...
	while not node.is_end():
		...
		try:
			...
			if info[0] is not None and GM_board.turn is True:				
				...
				stock_evaluation = info[0]/100
				new_stock_evaluation = -1 * stock_evaluation # Flip evaluations for Black
